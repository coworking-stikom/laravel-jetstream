<div class="p-6 sm:px-20 bg-white border-b border-gray-200" style="height: 700px; display: flex; justify-content: center; align-items: center;">
    <div>
        <x-jet-application-logo class="block h-12 w-auto" />
    </div>

    <!-- <div class="mt-8 text-2xl">
        Welcome to your Admin Kopi Combi!
    </div> -->
