            ...
            return DataTables::of($query)
                ...
                ->addColumn('images', function ($item) {
                    ...
                    foreach ($item->galleries as $image) {
                        // $imagesHtml .= '<img src="' . asset('path/to/image/folder/' . $image->image_path) . '" alt="' . $product->name . '" width="100" height="100"> ';
                        $imagesHtml .= '<img style="max-width: 50px;" class="mx-1" src="'. $image->url .'"/>';
                    }
